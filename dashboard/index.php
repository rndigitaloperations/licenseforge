<?php include $_SERVER['DOCUMENT_ROOT'] . '/includes/dashboard/stats.php'; ?>
...
<body class="bg-gray-900 text-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-1 p-8 w-full md:ml-64 md:w-auto">
        ...
        <section class="bg-gray-800 p-6 rounded-lg shadow">
            <h2 class="text-2xl font-semibold mb-6 text-center">Licenses Created Last 30 Days by Status</h2>
            <canvas id="licensesChart" height="120"></canvas>
        </section>
    </main>

    <script src="/includes/dashboard/chart-stats.php"></script>
