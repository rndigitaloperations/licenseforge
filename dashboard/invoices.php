<?php include $_SERVER['DOCUMENT_ROOT'] . '/includes/dashboard/invoices.php'; ?>
    ...
    <div class="flex flex-1">
        <main class="flex-1 p-8 md:ml-64">
            ...
            <div class="bg-gray-800 p-6 rounded shadow-lg mb-8">
                ...
                <div class="overflow-x-auto">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4" class="px-4 py-2 border text-center">No invoices found.</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            ...
            <div class="mt-4 bg-amber-100 text-amber-800 dark:bg-yellow-900 dark:text-yellow-100 border-l-4 border-amber-500 p-4 rounded flex items-start gap-2 text-sm">
              ...
              <div>
                 <strong>Note:</strong> Invoices cannot be created, deleted, or edited manually — all invoice management is handled automatically by the purchase system.
              </div>
            </div>
