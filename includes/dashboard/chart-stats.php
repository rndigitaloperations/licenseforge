...
const data = {
    ...
    datasets: [
        {
            label: 'Valid',
            data: <?php echo json_encode(array_values($statusData['valid'])); ?>,
        ...
        {
            label: 'Invalid',
            data: <?php echo json_encode(array_values($statusData['invalid'])); ?>,
        ...
        {
            label: 'Suspended',
            data: <?php echo json_encode(array_values($statusData['suspended'])); ?>,
